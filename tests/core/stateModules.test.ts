...
describe('State modules', () => {
  ...
  it('swap-and-pop removes obstacles safely', () => {
    ...
    entityState.addObstacle({
      x: 0, y: 0, radius: 1, dx: 0, dy: 0, id: 1, level: 0, parentId: null,
      scoreValue: 0, creationTime: 0, rotation: 0, rotationSpeed: 0, speed: 0, shape: []
    });
    entityState.addObstacle({
      x: 1, y: 1, radius: 1, dx: 0, dy: 0, id: 2, level: 0, parentId: null,
      scoreValue: 0, creationTime: 0, rotation: 0, rotationSpeed: 0, speed: 0, shape: []
    });
